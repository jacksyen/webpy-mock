...
class Rechange:
    ...
    def GET(self):
        ...
        self.db.execute('SELECT usercode, paymentmoney, breach, paymenttype FROM %s WHERE paymentstatus = "SUCCESS" and paymenttype != "000040" ORDER BY paymenttype' %Global.GLOBAL_TABLE_PAYMENT_USER)
